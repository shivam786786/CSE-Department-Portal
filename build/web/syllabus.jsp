...
<body>
    ...
    <%
    ArrayList<CSEFileDTO> file=ValidateDAO.getSyllabus();
    int i=0;
    %>
 ...
 <br>
 <label class="text-danger"> <h4>-Download Syllabus for Sem from Here:</h4></label>
...
<tr>
    <td><%=(i+1)%></td><td><a href="FileDownload?syllabus=<%=f.getFile()%>"><%=f.getFile()%></td>
 </tr>   
        <%
            i++;
        }
