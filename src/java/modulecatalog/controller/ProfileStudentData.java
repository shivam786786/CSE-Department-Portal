 ...
 * @author HP
 */
@WebServlet(name = "ProfileStudentData", urlPatterns = {"/ProfileStudentData"})
public class ProfileStudentData extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
                ...
                {
                    try{
                        String getphoto=StudentDAO.getPhoto(username);
         ...
         StudentDTO obj=new StudentDTO();
            System.out.println("1"+objValues.get(0)+"2"+objValues.get(4));
         obj.setPhoto(objValues.get(0));
         obj.setSname(objValues.get(1));
         ...
         obj.setRollno(objValues.get(6));
         boolean ans=StudentDAO.updateStudent(obj);
